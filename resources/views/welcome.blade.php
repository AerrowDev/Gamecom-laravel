        ...
        <div class="row">
            <div class="col-12">
                ...
                <nav class="main-nav">
                   ...
                   @auth
                   <a href="/profile/{{Auth::user()->id}}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                    <i class='fa fa-user'></i>     {{ Auth::user()->username }}</a>
                                        @else
                                      <li> <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 p-2 pb-2 mt-1">
